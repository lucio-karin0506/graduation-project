...
def add_BBands(df, period=20, nbdevup=2, nbdevdn=2, price='close'):
    # 볼린져 밴드 값 생성
...
def add_RSI(df, period=14, price='close'):
...
def add_MACD(df, fast_period=12, slow_period=26, signal_period=9, price='close'):
    macd, macd_signal, macd_hist = ta.MACD(df[price], fastperiod=fast_period, slowperiod=slow_period,
...
def add_STOCH(df, fastk_period=5, slowk_period=3, slowd_period=3, price1='high', price2='low', price3='close'):
    slowk, slowd = ta.STOCH(df[price1], df[price2], df[price3], fastk_period=fastk_period, slowk_period=slowk_period,
...
def add_STOCHF(df, fastk_period=5, fastd_period=3, price1='high', price2='low', price3='close'):
...
def add_MA(df, period=10, price='close'):
...
def add_EMA(df, period=30, price='close'):
...
def add_CMO(df, period=14, price='close'):
