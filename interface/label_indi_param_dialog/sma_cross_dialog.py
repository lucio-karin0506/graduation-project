...
'''
다이얼로그
1. 단순이동평균 파라미터 설정 다이얼로그
'''
class sma_cross_label_Param(QDialog):
    ...
    def confirmIt(self):
        ...
        label_indicator.sma_cross(gathering_info['df'], gathering_info['short'], gathering_info['long'],
        ...
        if msg == QMessageBox.Yes:
            sma_cross_label_Param.close(self)
        # 2. 그래프 생성
        # 3. 지표 리스트에 지표 목록 생성
